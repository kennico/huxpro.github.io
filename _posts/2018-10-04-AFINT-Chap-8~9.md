...
已知整数 $a,m$，满足 $ax\equiv1\pmod m$ 的整数 $x$ 称为 $a$ 的模 $m$ [乘法逆元](https://en.wikipedia.org/wiki/Modular_multiplicative_inverse)，写作 $x\equiv a^{-1}\pmod m$。应用前面解线性同余方程的方法可以立即得到以下结论：
